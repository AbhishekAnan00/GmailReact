...
const Compose = () => {
  ...
  return (
    <div className="width-all:fixed width-all:bottom-0 width-all:right-[150px] phone-sm:fixed phone-sm:bottom-0 phone-sm:right-0 phone-sm:w-[300px] phone-md:w-[320px] phone-lg:w-[340px] phone-xl:w-[360px] width-all:w-[450px]  flex flex-col shadow-2xl rounded-t-xl bg-white">
